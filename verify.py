...
TEST_FILES = [
    ...
    "cmd/libraryCatalogEvidence_test.go",
    "cmd/libraryCatalogBookkeeping_test.go",
    "cmd/libraryReviewRemediation_test.go",
    "cmd/buildOutput_test.go", "cmd/generation_change_immutable_test.go",
    "cmd/libraryInventory_test.go", "cmd/libraryObservation_test.go",
]
...
def prepare(out, working=False):
    ...
    tests = [name for name in tests if name not in {"TestParallelInventoryRejectsSymlinks", "TestCatalogManagedRealCalibreCommands", "TestCatalogManagedChangedPathValidation"}]
