...
class SshRsync(QObject):
    ...
    def create_state(self):
        ...
        remote_logan_tunnel_established = QState(jessica_session)
        remote_logan_rsync_established = QState(jessica_session)
        ...
        remote_logan_rsync_established.entered.connect(
